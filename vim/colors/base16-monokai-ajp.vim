...
if !has("gui_running")
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-monokai-ajp.sh"
  endif
endif
...
hi clear
syntax reset
let g:colors_name = "base16-monokai-ajp"
...
" Git highlighting
" Disable git commit color settings as they are unreadable.
